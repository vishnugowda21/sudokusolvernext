  ...
  return (
    <div style={styles.container}>
                ...
                style={{
                  ...
                  backgroundColor:
                    ...
                    selectedCell.col === colIndex
                      ? "#3498db" // Highlight color for selected cell
                      : cell
                      ? "#2c3e50"
                      : "#34495e", // Background color based on cell content
                  borderRight:
                    (colIndex + 1) % 3 === 0 ? "2px solid #2c3e50" : undefined,
                  borderBottom:
                    (rowIndex + 1) % 3 === 0 ? "2px solid #2c3e50" : undefined,
                }}
      ...
      <div style={styles.speedControl}>
        <label htmlFor="speedRange" style={styles.label}>
          Speed: {speed}%
        </label>
        <input
          type="range"
